...
One of my first projects when I started studying web development :tada:. A technical documentation page that focuses on building responsive websites.

Consider checking the repo's issues, all of my todos are in there :smile:

![Screenshot](./technicaldocumentation.png)
